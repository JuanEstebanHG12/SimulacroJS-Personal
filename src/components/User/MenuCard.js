export function MenuCard(item) {
    ...
    <div class="shadow-md relative w-[90%] h-full bg-white rounded-[0.8vw] flex flex-col items-center">
                <span class="absolute bg-gray-100 rounded-lg font-semibold text-xs py-1 px-3 top-2 left-3">Burgers</span>
                ...
                <div class="p-2 flex flex-col">
                    ...
                    <div class="flex font-extrabold gap-1">
                        <p>${item.name}</p>
                        <span class="text-green-500 text-lg">$8.99</span>
                    </div>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo
                    </p>
                    <button class="flex items-center justify-center bg-gray-200 rounded-md mt-3 mx-10 py-1" type="button">
